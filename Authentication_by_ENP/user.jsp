...
<body>
    ...
    if(request.getParameter("status")!=null){
     ...
     if(request.getParameter("activate")!=null){
        out.println("<script>alert('Your Account is Not Yet Activated!')</script>");
    }
    if(request.getParameter("status1")!=null){
    	
        out.println("<script>alert('Incorrect Hash Password!')</script>");
    }
    %>
  <div id="main">
    <header>
    ...
    <div id="site_content">
      ...
      <div id="content"><br></br>
          ...
          <center>
        <h1>User Login</h1>
            <form action="user_login.jsp" name="ulogin" method="post" onsubmit="return validation()"> 
<!--                  USERNAME:<br>-->
...
<font style="font-size: 17px;">        Are you New User? <a href="register.jsp" style="color: cadetblue">Register here</a>     </font>              
               <BR><Br><br> 
