    ...
    <div id="site_content">
      ...
      <div id="content">
          <fieldset style="background-color: #70D4E6;">
              <center>
			<h2 class="title"style="color: red;font-size: 20px;">Negative Password Function</h2>
              </center>
                        
                        <form action="ENP_Encryption_Process.jsp" name="ureg" style="position: relative;left: 110px;" method="post" onsubmit="return validation()"> 
<!--                  USERNAME:<br>-->

<%String uname=(String)session.getAttribute("uname");
String pwd=(String)session.getAttribute("pwd");
String hash=(String)session.getAttribute("hashcode");
...
<textarea name="hpassword" rows="5" cols="30" readonly><%=hash%></textarea><br></br>
<%
String str =hash;
    String result = "";String npwd= "";
    char[] messChar = str.toCharArray();

    for (int i = 0; i < messChar.length; i++) {
        result += Integer.toBinaryString(messChar[i]) + " ";
        npwd=result.replace("01", "*");
        npwd=result.replace("10", "*");
     
    }
    

%>
Generated Negative Password:<BR>

<textarea name="npassword" rows="10" cols="30" readonly><%=npwd%></textarea><br></br>


&nbsp;<input type="submit" id="but" value="Encryption Process" style="background-color: yellowgreen;color: #ffffff;width:200px"/>
&nbsp;&nbsp; <br></br>
