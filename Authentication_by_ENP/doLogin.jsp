    ...
    <div id="site_content">
      ...
      <div id="content">
          <fieldset style="background-color: #70D4E6;">
              <center>
			<h2 class="title"style="color: red;font-size: 20px;">Authentication Phase</h2>
              </center>
                        
                        <form action="doLogin2.jsp" name="ureg" style="position: relative;left: 110px;" method="post" onsubmit="return validation()"> 
<!--                  USERNAME:<br>-->
...
String hash=rs1.getString("npassword");
String npwd=rs1.getString("enpassword");
%>
...
<textarea name="npassword" rows="5" cols="40" readonly><%=hash%></textarea><br></br>
Encrypted Negative Password (ENP):<BR>

<textarea name="epassword" rows="5" cols="40" readonly><%=npwd%></textarea><br></br>


&nbsp;<input type="submit" id="but" value="Get Hash Password" style="background-color: yellowgreen;color: #ffffff;width:200px"/>
&nbsp;&nbsp; <br></br>
