    ...
    <div id="site_content">
      ...
      <div id="content">
          <fieldset style="background-color: #70D4E6;">
              <center>
			<h2 class="title"style="color: red;font-size: 20px;">Encrypted Negative Password Function</h2>
              </center>
                        
                        <form action="doRegistration1.jsp" name="ureg" style="position: relative;left: 110px;" method="post" onsubmit="return validation()"> 
<!--                  USERNAME:<br>-->
...
<textarea name="hpassword" rows="5" cols="40" readonly><%=hash%></textarea><br></br>
Negative Password:<BR>

<textarea name="npassword" rows="5" cols="40" readonly><%=npwd%></textarea><br></br>
Encrypted Negative Password (ENP):<BR>
<%
String encrypted_data=new AES().encrypt(npwd,hash);
%>
<textarea name="epassword" rows="5" cols="40" readonly><%=encrypted_data%></textarea><br></br>


&nbsp;<input type="submit" id="but" value="Registration" style="background-color: yellowgreen;color: #ffffff;width:200px"/>
&nbsp;&nbsp; <br></br>
